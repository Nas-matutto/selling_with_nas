...
**Prefer to watch instead?** I break down everything you need to know about Jev in the video below:
...
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:16px;margin:32px 0;background:#000;">
  <button type="button" aria-label="Play video: Everything you need to know about JEV AI - TypeSafe's new AI model" onclick="var f=document.createElement('iframe');f.src='https://www.youtube-nocookie.com/embed/CNCTIy7vAx0?autoplay=1&amp;rel=0';f.title='Everything you need to know about JEV AI - TypeSafe&#39;s new AI model';f.allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share';f.allowFullscreen=true;f.style.cssText='position:absolute;top:0;left:0;width:100%;height:100%;border:0;';this.replaceWith(f);f.focus();" style="position:absolute;inset:0;width:100%;height:100%;padding:0;margin:0;border:0;display:block;cursor:pointer;background:#000;">
    <img src="/images/jev-typesafe-video.webp" alt="Everything you need to know about JEV AI - TypeSafe's new AI model - video walkthrough" loading="lazy" decoding="async" width="1120" height="630" style="width:100%;height:100%;object-fit:cover;display:block;margin:0;border-radius:0;box-shadow:none;max-width:none;" />
