...
">
  ...
  <ul style="margin: 0; padding-left: 20px; line-height: 1.8;">
    ...
    <li>Once set up, you just describe your trip — dates, budget, destination — and the agent returns a complete plan with real prices and recommendations.</li>
...
3. Give it a name — for this example: *Travel Planning Agent*
...
This is the most important step. The instructions are what transform a general-purpose Claude conversation into a focused agent. Think of it as writing a job description — you're telling Claude exactly what role it plays and how it should approach every request.
...
As shown above, both Expedia and Booking.com are available in the Claude connector directory. Expedia is marked as trending — it was one of the newer travel integrations added to the platform. Booking.com gives you access to hotel inventory with reviews and pricing directly inside Claude.
...
Now the fun part. Start a new conversation inside your Project and just describe your trip naturally. You don't need to use any special syntax — just write as if you're messaging a human travel assistant.
